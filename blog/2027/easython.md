...
现在AI发展已经很成熟，很多人习惯于用AI寻找答案，代替传统的搜索引擎，操作更便捷。但是在本章，笔者依然要强调“传统”资料的重要性。
...
Flet默认有assets，也可以自定义。

NiceGUI则可以手动注册、自定义挂载点。

PySide6则使用了Qt的资源系统（qrc）。
...
## x 27xx期：xxx控件——解决xxx问题（更新中）（开发实战模板）

### x.1 背景

介绍问题的来源，需要详细完整介绍问题内容、相关要求。

### x.2 准备

说清楚需要安装哪些库、需要哪些文档、需要准备哪些资源文件。
...
尝试解决，代码复杂的话拆分为几步。如果一次不能成功，也要记录下来，进行下一轮的分析-解决过程，但新的分析解决过程要另起一节，本节将改名为第一次解决（失败），后面按照顺序命名为第二次解决（失败）、第三次解决（失败）……第n次解决（成功）。



### x.5 总结

在解决完之后，总结问题的难点、解决过程中的关键点，最好给出一个简短的结论或者口诀，方便记忆。