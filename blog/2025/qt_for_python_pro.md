...
![2025_3_1](qt_for_python_pro.assets/2025_3_1.png)
...
![2025_4_1](qt_for_python_pro.assets/2025_4_1.png)
...
![2025_4_2](qt_for_python_pro.assets/2025_4_2.png)
...
![2025_4_3](qt_for_python_pro.assets/2025_4_3.png)
...
![2025_5_2](qt_for_python_pro.assets/2025_5_2.png)
...
![2025_6_1](qt_for_python_pro.assets/2025_6_1.png)
...
![2025_6_2](qt_for_python_pro.assets/2025_6_2.png)
...
![2025_6_3](qt_for_python_pro.assets/2025_6_3.png)
...
![2025_6_4](qt_for_python_pro.assets/2025_6_4.png)
...
![2025_7_1](qt_for_python_pro.assets/2025_7_1.png)
...
![2025_7_2](qt_for_python_pro.assets/2025_7_2.png)
...
![2025_8_1](qt_for_python_pro.assets/2025_8_1.png)
...
![2025_9_1](qt_for_python_pro.assets/2025_9_1.png)
...
![2025_9_2](qt_for_python_pro.assets/2025_9_2.png)

从左边拖一个Push Button到中间的窗口中，这样就在窗口中创建了一个按钮控件：

![2025_9_3](qt_for_python_pro.assets/2025_9_3.png)
...
![2025_9_6](qt_for_python_pro.assets/2025_9_6.png)
...
![2025_9_7](qt_for_python_pro.assets/2025_9_7.png)

在弹出的窗口中，可以选择复制（如箭头所示）还是保存为单独的文件：

![2025_9_8](qt_for_python_pro.assets/2025_9_8.png)

也可以在终端执行`pyside6-uic {UI文件路径} [-o {输出的Python文件路径}]`命令（`-o`选项为可选，表示是否输出为Python文件，下面的输入结果实际上没有使用该选项），结果是一样的：

![2025_9_9](qt_for_python_pro.assets/2025_9_9.png)
...
![2025_9_10](qt_for_python_pro.assets/2025_9_10.png)
...
![2025_10_1](qt_for_python_pro.assets/2025_10_1.png)
...
![2025_10_2](qt_for_python_pro.assets/2025_10_2.png)
...
![2025_11_1](qt_for_python_pro.assets/2025_11_1.png)
...
![2025_12_1](qt_for_python_pro.assets/2025_12_1.png)

当然，除了在代码中调用Python接口设置控件的大小，还可以在修改UI文件时设置控件`geometry`属性中的宽度、高度：

![2025_12_2](qt_for_python_pro.assets/2025_12_2.png)

除了上面两种方法，修改控件的样式表，也能实现相同的效果。

将`geometry`属性初始化，右键控件，选择改变样式表，输入如下内容：

![2025_12_3](qt_for_python_pro.assets/2025_12_3.png)
...
![2025_12_4](qt_for_python_pro.assets/2025_12_4.png)
...
![2025_12_5](qt_for_python_pro.assets/2025_12_5.png)
...
- 属性选择器，使用`[{属性名}={属性值（字符串类型）}]`表示，表明样式适用于控件属性（只能匹配部分值可以转换为字符串的属性）为指定值的控件。比如，匹配`text`属性为`'click2'`的控件：
  ...
  ![2025_12_6](qt_for_python_pro.assets/2025_12_6.png)
  ...
  ![2025_12_7](qt_for_python_pro.assets/2025_12_7.png)
...
- 类选择器，给控件的类名前加一个英语句号（`.`），表明样式只适用于该控件（控件类的实例），其效果相当于样式适用于控件属性`class`中包含指定控件类名的控件。比如，`.QPushButton`等效于`[class~='QPushButton']`。示例如下：
  ...
  ![2025_12_8](qt_for_python_pro.assets/2025_12_8.png)
...
- ID 选择器，给控件`objectName`属性的值前加一个井号（`#`），表明样式适用于控件属性`objectName`为指定值的控件。示例如下：
  ...
  ![2025_12_9](qt_for_python_pro.assets/2025_12_9.png)
...
- 内部子控件选择器，使用`::{内部子控件名}`表示，表明样式适用于指定的内部子控件。这里的内部子控件指的是有些控件的组成部分本质上是单独的控件，所以，可以通过内部子控件选择器进行匹配，设置这些控件的样式。比如，给按钮设置下拉菜单之后，按钮会多出一个菜单指示器，可以使用`::menu-indicator`匹配：
  ...
  ![2025_12_10](qt_for_python_pro.assets/2025_12_10.png)
...
- 伪类（状态类）选择器，使用`:{伪类（状态类）}`表示，表明样式适用于指定状态（比如，被禁用，被点击）的控件。示例如下：
  ...
  ![2025_12_11](qt_for_python_pro.assets/2025_12_11.png)
...
![2025_12_12](qt_for_python_pro.assets/2025_12_12.png)
...
![2025_13_1](qt_for_python_pro.assets/2025_13_1.png)
...
![2025_13_2](qt_for_python_pro.assets/2025_13_2.png)
...
![2025_13_3](qt_for_python_pro.assets/2025_13_3.png)
...
![2025_13_4](qt_for_python_pro.assets/2025_13_4.png)

神奇的布局控件是如何发挥作用呢？

就以上面的示例为例，布局控件相当于一个容器，对外占据全部可用空间，对内自动调整内部控件的大小、位置，无需额外、单独、手动调整每个控件的大小、位置，大致结构如下图所示：

![2025_13_5](qt_for_python_pro.assets/2025_13_5.png)
...
- `QVBoxLayout`控件，垂直布局控件，布局内的控件垂直排布，如下图所示：
  ...
  ![2025_13_6](qt_for_python_pro.assets/2025_13_6.png)

- `QHBoxLayout`控件，水平布局控件，布局内的控件水平排布，如下图所示：

  ![2025_13_7](qt_for_python_pro.assets/2025_13_7.png)

- `QGridLayout`控件，网格布局控件，布局内的控件占据一个网格（可以合并网格），如下图所示：

  ![2025_13_8](qt_for_python_pro.assets/2025_13_8.png)

虽然基本的布局控件就这么几种，但布局控件可以组合使用。程序中千变万化的界面布局，实际上大多是这些布局控件的组合：

![2025_13_9](qt_for_python_pro.assets/2025_13_9.png)
...
- `setDirection`方法，修改布局的排布方向。比如，可以修改垂直布局的排布方向为从下至上：
  ...
  ![2025_13_10](qt_for_python_pro.assets/2025_13_10.png)
...
![2025_13_11](qt_for_python_pro.assets/2025_13_11.png)
...
![2025_13_12](qt_for_python_pro.assets/2025_13_12.png)
...
![2025_13_13](qt_for_python_pro.assets/2025_13_13.png)
...
![2025_13_14](qt_for_python_pro.assets/2025_13_14.png)
...
![2025_13_15](qt_for_python_pro.assets/2025_13_15.png)
...
![2025_13_16](qt_for_python_pro.assets/2025_13_16.png)
...
![2025_13_17](qt_for_python_pro.assets/2025_13_17.png)
...
![2025_14_1](qt_for_python_pro.assets/2025_14_1.png)
...
![2025_14_2](qt_for_python_pro.assets/2025_14_2.png)
...
![2025_15_1](qt_for_python_pro.assets/2025_15_1.png)
...
![2025_16_1](qt_for_python_pro.assets/2025_16_1.png)
...
![2025_17_1](qt_for_python_pro.assets/2025_17_1.png)
...
![2025_17_2](qt_for_python_pro.assets/2025_17_2.png)
...
![2025_17_3](qt_for_python_pro.assets/2025_17_3.png)

可以直接确定，也可以调整下面的目标语言之后再确定，笔者这里调整下面的目标语言为简体中文：

![2025_17_4](qt_for_python_pro.assets/2025_17_4.png)

点击对应的原文，然后输入翻译结果，再点击完成按钮，一条原文即可翻译完成：

![2025_17_5](qt_for_python_pro.assets/2025_17_5.png)

翻译完所有原文后，按`ctrl+s`键或者点击保存按钮，将源文件保存。此时可以使用`pyside6-lrelease .\main.ts`命令编译、生成语言包，也可以使用`文件-发布`（或者`发布为`）编译、生成语言包：

![2025_17_6](qt_for_python_pro.assets/2025_17_6.png)
...
![2025_17_7](qt_for_python_pro.assets/2025_17_7.png)
...
![2025_17_8](qt_for_python_pro.assets/2025_17_8.gif)
...
![2025_17_9](qt_for_python_pro.assets/2025_17_9.png)
...
![2025_17_10](qt_for_python_pro.assets/2025_17_10.png)
...
![2025_17_11](qt_for_python_pro.assets/2025_17_11.png)
...
![2025_18_1](qt_for_python_pro.assets/2025_18_1.png)
...
![2025_18_2](qt_for_python_pro.assets/2025_18_2.png)
...
![2025_19_1](qt_for_python_pro.assets/2025_19_1.png)
...
![2025_19_2](qt_for_python_pro.assets/2025_19_2.png)
...
![2025_19_3](qt_for_python_pro.assets/2025_19_3.png)
...
![2025_19_8](qt_for_python_pro.assets/2025_19_8.png)
...
![2025_20_1](qt_for_python_pro.assets/2025_20_1.png)
...
- `parent`参数，`PySide6.QtWidgets.QWidget`类型，表示父控件。如果指定了父控件，那么该控件显示时，会使用父控件的位置或者嵌在父控件内（取决于该控件是否支持嵌入到其他控件）。不指定或者为`None`，则控件会以默认位置、状态显示。

- `flags`参数，`PySide6.QtCore.Qt.WindowType`类型，表示控件独立显示时使用的窗口类型。
...
- `iconPixmap`参数，仅限关键字参数，`PySide6.QtGui.QPixmap`类型，表示使用自定义图片当作图标。示例如下：
  ...
  ![2025_20_2](qt_for_python_pro.assets/2025_20_2.png)
...
- `textFormat`参数，仅限关键字参数，`PySide6.QtCore.Qt.TextFormat`类型，表示主要文本、信息文本的文本格式（纯文本、富文本、标记文本、自动识别富文本和纯文本，完整用法参考https://doc.qt.io/qtforpython-6/PySide6/QtCore/Qt.html#PySide6.QtCore.Qt.TextFormat）。示例如下：
  ...
  ![2025_20_3](qt_for_python_pro.assets/2025_20_3.png)
...
- `options`参数，仅限关键字参数，可以为`PySide6.QtWidgets.QMessageBox.Option.DontUseNativeDialog`，表示是否禁用系统原生的消息对话框，改用Qt控件的实现方式。
...
- `addButton`方法（完整用法可参考 https://doc.qt.io/qtforpython-6/PySide6/QtWidgets/QMessageBox.html#PySide6.QtWidgets.QMessageBox.addButton），在对话框中添加一个`PySide6.QtWidgets.QMessageBox.StandardButton`类型按钮，并返回该按钮。
  ...
  ![2025_20_4](qt_for_python_pro.assets/2025_20_4.png)
  ...
  ![2025_20_5](qt_for_python_pro.assets/2025_20_5.png)
...
![2025_21_1](qt_for_python_pro.assets/2025_21_1.png)
...
- `setLabelText`方法，用于设置非原生对话框指定标签的文本。支持以下区域：
  ...
  ![2025_21_3](qt_for_python_pro.assets/2025_21_3.png)
...
- `setNameFilter`方法、`setNameFilters`方法，限定打开文件的文件名（前者限制为单个文件名，后者可以指定多个文件名）。示例如下：
  ...
  ![2025_21_4](qt_for_python_pro.assets/2025_21_4.png)
...
![2025_21_5](qt_for_python_pro.assets/2025_21_5.png)
...
![2025_21_6](qt_for_python_pro.assets/2025_21_6.png)
...
- `getDouble`方法，创建一个只允许输入小数的输入对话框控件：
  ...
  ![2025_21_7](qt_for_python_pro.assets/2025_21_7.png)
...
- `getItem`方法，创建一个只允许从下拉框选择的输入对话框控件：
  ...
  ![2025_21_8](qt_for_python_pro.assets/2025_21_8.png)
...
- `getText`方法，创建一个可以输入任意单行文本的输入对话框控件：
  ...
  ![2025_21_9](qt_for_python_pro.assets/2025_21_9.png)
...
- `getMultiLineText`方法，创建一个可以输入任意多行文本的输入对话框控件：
  ...
  ![2025_21_10](qt_for_python_pro.assets/2025_21_10.png)
...
![2025_21_11](qt_for_python_pro.assets/2025_21_11.png)
...
前面简单介绍了文件选择对话框控件之后，还是有读者不太理解具体用法，在实际使用中存在问题。于是，笔者思索再三，决定写一段示例代码，用于选择并打开指定类型的文件。
...
想要弄清楚这个问题，需要先简单了解一下Qt中控件、图形使用的坐标系，以及坐标的实际含义。在Qt中，坐标系的原点为窗口的左上角的像素点，向右为X轴正方向，向下为Y轴的正方向，坐标则表示对应的像素点。因此，如果有一个原点为`(0,0)`、宽4高3的矩形，那矩形的12个像素点的坐标如下图所示：

![2025_23_1](qt_for_python_pro.assets/2025_23_1.png)
...
![2025_25_1](qt_for_python_pro.assets/2025_25_1.png)
...
- `icon`参数，仅限位置参数（第一个位置参数），`PySide6.QtGui.QIcon`类型或者`PySide6.QtGui.QPixmap`类型，表示按钮的图标或者图片。
  ...
  ![2025_25_2](qt_for_python_pro.assets/2025_25_2.png)
